...
Put simply, a plan is (1) a problem you're facing with (2) one or more
approaches that solve that problem. We believe that thinking up and saying your
plan out loud is a better way of solving problems than diving in immediately:

- The process promotes solving problems _with intention_ instead of _blindly_
- Writing a plan forces you to collect your thoughts
...
- People have the opportunity to correct misconceptions, suggest alternatives,
  or otherwise improve your plan
...
Make sure you think hard about what your _actual problem scope_ is. Let's say
your task is to "build a function that takes a number and outputs that number's
...
That's not a very specific plan. It doesn't give you any actionable steps to
take, and it doesn't give anything substantive enough for someone else to
comment on. One of the reasons is because it misattributes the problem. The
problem isn't that you need to work on a Lebowski coefficient; the problem is
you don't know what a Lebowski coefficient is.

This is a much better plan:

```
I'm working on the Lebowski coefficient and I don't know what the fuck a
...
better than Google randos, or that our project cut Lebowski coefficients last
week.

Plans about exploratory problems are some of the most useful to think out loud
about, because they have more play and generate more discussion than problems
you have a cut-and-dried solution to.
